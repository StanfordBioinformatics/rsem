...
parser.add_argument("-o","--outfile",required=True,help="Name of the output data file that will contain a single line with the information to plot. If the --plot option was passed, a barplot file will be output with the same name except for a .jpeg extension. ")
parser.add_argument("-p","--plot",action="store_true",help="Presence of this options indicates to plot the results as a barplot using R by making a call to plot_perc_change.r.")
