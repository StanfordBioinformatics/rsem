...
def parse_rsem_expr_results(infile=results_file,by_name=False):
	"""
...
ctl_mat = parse_rsem_expr_results(infile=ctl_mat_file,by_name=by_name)

sample_mat_file = args.sample_rsem_results
sample_file_name = os.path.basename(sample_mat_file).split(".")[0]
sample_mat = parse_rsem_expr_results(infile=sample_mat_file,by_name=by_name)
